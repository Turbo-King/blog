...
我们都知道编写 Web 内容很麻烦.但市面上有一种 [WYSIWYG]^(所见即所得) 编辑器可以帮助我们减轻了这一任务. 但通常会导致代码太糟, 但有时更糟糕的是, 网页也会很丑，毕竟代码不是我们亲手所写，讲究的就是两字——省事，以至于其他都与我无关.

对于通常伴随的所有复杂和丑陋的问题, **Markdown** 生成 **HTML** 内容的方式是一种更好的选择.
